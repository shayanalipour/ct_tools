...
def fb_login(driver, username, password):
    ...
    try:
        id_box = driver.find_element(By.NAME, "email")
    except:
...
def update_list(uids, driver, ct_url, action):
    ...
    for xpath in manage_paths:
        try:
            manage_tab = driver.find_element(By.XPATH, xpath)
            manage_tab.click()
            time.sleep(4)
            break
        except:
    ...
    try:
        ...
        search_tab = driver.find_element(By.XPATH, xpath)
        search_tab.click()
        time.sleep(4)
    except:
    ...
    for uid in uids:
        ...
        try:
            ...
            sign = driver.find_element(By.XPATH, xpath + "/i")
...
def grab_posts(uids, driver, ct_url):
    ...
    for uid in uids:
        ...
        view_tab = driver.find_element(By.XPATH, xpath)
        view_tab.click()
        time.sleep(4)
        try:
        ...
        ### remove page
        xpath = '//*[@id="manage-lists-nav"]/li[2]/a'
        search_tab = driver.find_elemet(By.XPATH, xpath)
        search_tab.click()
        time.sleep(4)
...
def clear_list(driver):
    ...
    for i in range(1, 10):
        try:
            xpath = (
                "/html/body/div[3]/div/div[3]/div/div/div[2]/div[2]/div[4]/div/div[2]/div/ul/li["
                + str(i)
                + "]/ul/li/div[2]/div/a"
            )
            remove_button = driver.find_element(By.XPATH, xpath)
            remove_button.click()
            time.sleep(1)
            xpath = (
                "/html/body/div[3]/div/div[3]/div/div/div[2]/div[2]/div[4]/div/div[2]/div/ul/li["
                + str(i)
                + "]/ul/li/div[2]/div/div/a[1]"
            )
            remove_confirm = driver.find_element(By.XPATH, xpath)
